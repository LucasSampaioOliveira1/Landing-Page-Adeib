...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Adeibson Araujo" }],
  creator: "Adeibson Araujo",
  publisher: "Adeibson Araujo",
  alternates: {
    canonical: "/",
  },
  robots: {
  ...
  openGraph: {
    ...
    title: siteTitle,
    description: siteDescription,
    siteName: "Adeibson Araujo Psicologia",
    images: [
      {
        url: "/img/Sala1.png",
        width: 1200,
        height: 630,
        alt: "Consultorio de Adeibson Araujo",
      },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Psychologist",
        name: "Adeibson Araujo",
        description: siteDescription,
        url: siteUrl,
        image: `${siteUrl}/img/logo.svg`,
        telephone: "+55 98 8408-5515",
        areaServed: "BR",
        availableLanguage: ["pt-BR"],
      },
      {
        "@type": "WebSite",
        name: "Adeibson Araujo Psicologia",
        url: siteUrl,
        inLanguage: "pt-BR",
      },
    ],
